...
// 1) Al momento que la persona inicia sesión, si las validaciones que ya tenemos implementadas han sido exitosas, deberemos almacenar la información del usuario en el LocalStorage.
...
// 3) Una vez iniciada la sesión, la misma se deberá mantener en ese estado para el caso de que la persona recargue la página. Para ello, deberás validar si existe información del usuario al momento en
